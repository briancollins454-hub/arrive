...
import { Building2, Plus, ExternalLink, Ban, CheckCircle2, Loader2, CreditCard } from 'lucide-react';
      ...
      {isLoading ? (
        ...
        <Card variant="dark">
          <CardContent className="py-16 text-center">
            <Building2 size={40} className="text-steel/40 mx-auto mb-4" />
            <p className="text-steel font-body mb-4">No hotels onboarded yet.</p>
            <Button onClick={() => navigate('/admin/onboard')}><Plus size={16} className="mr-2" /> Onboard your first hotel</Button>
          </CardContent>
        </Card>
      ) : (
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {h.is_active ? (
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg text-steel hover:text-emerald-400 hover:bg-emerald-400/10 transition-all"
