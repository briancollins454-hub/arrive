...
import { TrendingUp, Building2, AlertTriangle, ExternalLink, Loader2 } from 'lucide-react';
  ...
  return (
    <PageShell variant="dark" className="max-w-5xl">
      <PageHeader
        variant="dark"
        title="Billing"
        description="Subscriptions and recurring revenue across all hotels"
      />

      {isLoading ? (
        <PageLoading variant="dark" layout="stats" />
      ) : (
        <>
