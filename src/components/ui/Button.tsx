...
<<<<<<< HEAD
        vibrant: 'text-white shadow-vibrant bg-[linear-gradient(120deg,#c9a84c_0%,#ff4dd9_38%,#b667ff_64%,#2dd4ff_100%)] bg-[length:300%_100%] animate-gradient-pan [animation-duration:14s] hover:-translate-y-0.5 hover:shadow-[0_14px_48px_-8px_rgba(182,103,255,0.5)] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/25 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-700',
=======
        vibrant: 'bg-gradient-to-r from-gold via-gold-light to-gold text-midnight shadow-[0_4px_16px_rgba(201,168,76,0.25),inset_0_1px_0_rgba(255,255,255,0.25)] hover:shadow-[0_8px_32px_rgba(201,168,76,0.4)] hover:-translate-y-0.5 active:translate-y-0',
>>>>>>> 2d5c699 (﻿feat(ui): uniform design system across all pages)
